      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Cottage Price</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Booker</label>
              <select class="form-control" name="a_name" id="exampleFormControlSelect1" >
                <?php

                $ret="SELECT * FROM tms_admin where a_name = 'System Admin'"; //sql code to get to ten trains randomly
                ...
                {
                ?>
                <option><?php echo $row->a_name;?> </option>
                <?php }?> 
              </select>
            </div>
